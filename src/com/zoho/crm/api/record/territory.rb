...
module Record
  class Territory
    ...
    def assigned_by
      ...
      # @param assigned_by [Users::User] An instance of Users::User

    def assigned_by=(assigned_by)
      if assigned_by!=nil and !assigned_by.is_a? Users::User
        raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: assigned_by EXPECTED TYPE: User', nil, nil)
      end
