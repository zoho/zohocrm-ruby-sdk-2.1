...
module Fields
  class MultiSelectLookup
    ...
    def connected_module
      ...
      # @param connected_module [String] A String

    def connected_module=(connected_module)
      if connected_module!=nil and !connected_module.is_a? String
        raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: connected_module EXPECTED TYPE: String', nil, nil)
      end
