...
module Fields
  class HistoryTracking
    ...
    def duration_configured_field
      ...
      # @param duration_configured_field [Field] An instance of Field

    def duration_configured_field=(duration_configured_field)
      if duration_configured_field!=nil and !duration_configured_field.is_a? Field
        raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: duration_configured_field EXPECTED TYPE: Field', nil, nil)
      end
