  ...
  module Fields
    class PickListValue
      ...
      def forecast_category
        ...
        # @param forecast_category [Integer] A Integer

      def forecast_category=(forecast_category)
        if forecast_category!=nil and !forecast_category.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: forecast_category EXPECTED TYPE: Integer', nil, nil)
        end
